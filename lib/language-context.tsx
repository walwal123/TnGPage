...
const translations: Record<string, Record<Language, string>> = {
  ...
  "expertise.dx.autocapture": { ko: "API 기�� 청구서류 데이터화 서비스 - 보험금 자동 산출, 착오지급 탐지, 보험범죄 탐지에 활용", en: "API-based claim document digitization service - used for automatic insurance calculation, erroneous payment detection, and insurance fraud detection" },
  "expertise.dx.autoclaim": { ko: "API 기반 심사 자동화 서비스 - Autodit 기술과 Autocapture의 생성 데이터를 ���합하여 보험금 심사 업무를 획기적으로 자동화", en: "API-based review automation service - dramatically automates insurance review by combining Autodit technology with Autocapture generated data" },
  ...
  // Branch Info Page
  "branch.info.hero": { ko: "거���정보", en: "Branch Info" },
  ...
  "recruit.system.bottom.reward": { ko: "보��", en: "reward" },
