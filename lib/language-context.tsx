...
const translations: Record<string, Record<Language, string>> = {
  ...
  "business.overview.coverage.propinv.title": { ko: "재물/배상책임/특종보험 조사업무", en: "Property/Liability/Specialty Insurance Investigation" },
