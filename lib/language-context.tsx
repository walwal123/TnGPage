...
const translations: Record<string, Record<Language, string>> = {
  ...
  "company.info.name.value": { ko: "티앤지손해사정주식회사", en: "T&G Loss Adjustment Co., Ltd." },
  ...
  "expertise.col3.title": { ko: "오류율", en: "Error Rate" },
  ...
  "expertise.dx.autoclaim": { ko: "API 기반 심사 자동화 서비스 - Autodit 기술과 Autocapture의 생성 ���이터를 융합하여 보험금 심사 업무를 획기적으로 자동화", en: "API-based review automation service - dramatically automates insurance review by combining Autodit technology with Autocapture generated data" },
  ...
  "company.location.line1.exit11": { ko: "종로3가역 11번출구 하차 후 도보 5분", en: "Exit 11 at Jongno 3-ga Station, 5 min walk" },
  "company.location.line1.exit12": { ko: "종로 5가역 12번출구 하차 후 도보 5분", en: "Exit 12 at Jongno 5-ga Station, 5 min walk" },
  "company.location.line2.exit": { ko: "을지로 4가역 3,4번 출구 하차 후 도보 10분", en: "Exit 3,4 at Euljiro 4-ga Station, 10 min walk" },
  "company.location.line3.exit11": { ko: "종로3가역 11번출구 하차 후 도보 5분", en: "Exit 11 at Jongno 3-ga Station, 5 min walk" },
  "company.location.line5.exit11": { ko: "종로3가역 11번출구 하차 후 도보 5분", en: "Exit 11 at Jongno 3-ga Station, 5 min walk" },
