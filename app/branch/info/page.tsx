...
export default function BranchInfoPage() {
  ...
  const branchDataKo = [
    ...
    { team: "경기북부팀", work: "인보험", location: "경기 남양주시 순화궁로 116", searchAddress: "경기 남양주시 순화궁로 116" },
                  ...
                  {branchData.map((row, index) => (
                    <tr 
                      ...
                      className={`cursor-pointer transition-colors ${
                        selectedBranch.location === row.location && selectedBranch.team === row.team && selectedBranch.work === row.work
